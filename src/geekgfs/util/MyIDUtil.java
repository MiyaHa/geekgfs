...
public class MyIDUtil {
    ...
    private final static long workerId = 0L;
    private final static long regionId = 0L;

    private static MyIDUtil instance = new MyIDUtil();
    public MyIDUtil() {}
    public static MyIDUtil getInstance(){
        return instance;
    }
